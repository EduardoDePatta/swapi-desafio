...
const Checkout = () => {
  ...
  const schema = Yup.object().shape({
    ...
    tel: Yup.string()
      .min(
        11,
        "You need to insert a phone number with only numbers and in the format 00123456789(Example: 47991966020)"
      )
      .max(
        11,
        "You need to insert a phone number with only numbers and in the format 00123456789(Example: 47991966020)"
    ...
    registryNumber: Yup.string()
      .min(10, "Registry Number must be with 11 or 14 numbers total")
    ...
    ownerName: Yup.string()
      .min(3, "Must be 3 characters or greather")
      .max(30, "Must be 30 characters or less"),
    cvv: Yup.string().min(3, "Must be 3 digits").max(3, "Must be 3 digits"),
  });
  ...
  const handleCancelCheckout = () => {
    if (!selectedVehicle) return;
    console.log(
      `Você acabou de cancelar a compra de: ${selectedVehicle.name}`,
      selectedVehicle
    );
            ...
            <UserPaymentWrapper>
              <Infos>
                ...
                <TextField
                  ...
                  handleUpdateAddress={(
                    event: React.FocusEvent<HTMLInputElement>
                  ) => handleUpdateAddress(event, setFieldValue)}
                ...
                <TextField
                  ...
                  type="text"
                  placeholder="Insert your Complement Address.."
                ...
                <TextField
                  ...
                  name="state"
                  type="text"
                  placeholder="Insert your Federation Unit.."
                  error={errors.state}
                />
              </Infos>
              ...
              <Infos>
                ...
                <CreditCard isCreditCard={paymentMethod === "creditCard"}>
                  <TextField
                    ...
                    type="text"
                    placeholder="Insert your credit card number.."
                  ...
                  <TextField
                    ...
                    name="validity"
                    type="text"
                    placeholder="Insert your credit card validity (Ex. 0122).."
                  ...
                  <TextField
                    ...
                    name="ownerName"
                    type="text"
                    placeholder="Insert the credit card owner name.."
